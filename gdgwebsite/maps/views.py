...
from agents.myAgentAI_converted import topics_generator, api_topics_generator
...
def upload_pdf(request):
    if request.method == 'POST' and 'file' in request.FILES:
        ...
        ROOT.objects.create(name=pdf_file.name, json_map=python_object)
...
def qea(request):
    try:
        ...
        return JsonResponse()  # Return the 'name' and 'json_map' as JSON response
